...
//   const RegisterDelivery({Key? key}) : super(key: key);
//
//   @override
...
//   //   var uri = Uri.parse('${Apipath.getCategoryUrl}');
...
//     };
//     var request = http.MultipartRequest('POST', Uri.parse('${Apipath.deliveryRegistrationUrl}'));
//     request.fields.addAll({
//     'name': '${nameController.text.toString()}',
//     'mobile': '${mobileController.text.toString()}',
//     'email':'${emailController.text.toString()}',
//     'address': '${pickLocationController.text.toString()}',
//     'vehicle': '${selectVehicle.toString()}',
//     'vehicle_no': '${vehicleController.text.toString()}',
//
//     });
//     // if (rcImage != null) {
//       request.files.add(
//           await http.MultipartFile.fromPath('rc_book', rcImage!.path));
//     // }
//     // if (aadharImage != null) {
//       request.files.add(
...
//         ),
//         title: Text("Delivery Service", style: TextStyle(
...
//                   padding: const EdgeInsets.only(top: 5.0, bottom: 10),
//                   child: Container(
//                     child: TextFormField( controller: vehicleController,
